                    ...
                    <div class="experience-top">
                        <div class="experience-top-item d-flex align-items-end justify-content-between">
                            <div class="experience-information">
                                <h2 class="title-experience text-uppercase"><a href="#" title="" class="color-experience">Lợi thế khi nhượng
                                ...
                                <a href="#" title="Xem thêm" class="viewmore d-flex justify-content-center align-items-center">XEM THÊM</a>
                            </div>
                            <div class="experience-image">
                                <a href="#" class="color-experience" title="Title">
                                    <img src="<?= get_template_directory_uri() ?>/assets/images/images-experience.jpg"
                                         alt="">
                                </a>
                            </div>
                        </div>
